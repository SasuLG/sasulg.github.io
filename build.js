...
var images = ['odomo.png', 'biosphère.png', /*'Installation de Poste.PNG', 'BD.PNG', 'site.png','PESTEL.png',*/ 'GenMdp.PNG', 'Quizz.png', 'Memories.png', 'puissance4.png', 'jpo.png', 'graphe4.png', "game.png", "series.png", "livingforest3.png", "birds.png", "chess.png", "anges.png", "blinkApp.png", "lsf.png", "Skeletum.png" , "Rubiks.png", "god_of_chaos.png", "myanylist.png"]

var tabTitre =  ['Odomo', 'Biosphère', /*'Installation de poste', 'Création de base de données', "Conception d'un site web", 'Analyse PESTEL',*/ 'Générateur de mot de passe', 'Quizz', 'Memories', 'Puissance 4', 'Jeu Java', 'Exploraiton algo', "Revenge of Deadly Sins" , "Développement d'appli", "Living Forest", "Birds", "Chess 3D AI", "Anges Mdm", "Blink App", "LSF Recognition", "Skeletum" , "Rubik's", "God of Chaos", "MyAnyList"]
...
,*/"Générateur de mot de passe, avec plusieurs options(nb mdp, nb caractères, type caractères)", "Un quizz avec plusieurs niveau de difficulté ansi qu'un niveau bonus (avec quelques petits secrets)", "Un jeu de Memories en local (à 1 ou deux joueurs) avec plusieurs niveau de difficulté", "Jeu de puissance 4 contre une IA ou en local à 2 joueurs",
"Jeu pour appprendre les bases de java qui consiste à déplacer une grenouille jusqu'au nénuphar", "Recherche en profondeur, largeur, algo dijkstra...", "Jeu 2D rpg affrontant des vagues d'ennemies avec de nouveaux pouvoirs", "Site de catalogue et de suivies de séries "
, "Jeu de société coopératif adapté en jeu vidéo en ligne", "Simulation de vol de nuées d'oiseaux (godot)", "Jeu d'échecs 3D avec décor (blender) et IA", "Site des Anges Mdm", "Application (santé) de suivi de clignement des yeux", "Reconnaissance de la Langue des Signes Française (actuellement alphabet)", "Quizz 3d des os du corps humain" , "Rubik's cube 3D", "Génération procedurale de Terre", "Site de catalogue de séries/animés/films ET bien plus"]
...
, "Cooperative board game adapted into a video game", "Simulation of flocks of birds", "Artificial intelligence for chess game", "Site of Angels Mdm", "Eye blink tracking application", "Recognition of French Sign Language", "3D quiz of the bones of the human body" , "Catalog site of series/animes/movies AND much more"]

var date = ['2022', '2022', /*'2022', '2022', '2022', '2022',*/ '2023', '2023', '2023', "2023",'2023', '2023', "2023", "2024", "2025", "2025", "2025", "2025", "2025", "2025~2026", "2026" , "2026", "2026", "2024~2026"]
var nbLanguage = [1, 1, /*1, 1, 1, 1,*/ 2, 2, 2,2,1,1, 2, 4, 3, 2, 3, 3, 2, 2, 3, 2, 2, 4]
var nbLanguageTotal = nbLanguage.map(x => x).reduce((a, b) => a + b, 0) - 1
var Language = ['Java', 'Java', /*'Shell', 'SQL', 'Html-Css', 'Managment',*/ 'javascript', 'Html-Css', 'javascript', 'Html-Css', 'javascript', 'Html-Css', "Html-Css", "javascript",'Java', "Java", "Html-Css", "javascript", "PHP", "Html-Css","javascript", "Managment", "javascript", "Html-Css", "React",  "Python", "Godot", "CSharp", "Unity", "Blender", "Html-Css", "javascript", "Nextjs", "Python", "OpenCV","Python", "OpenCV", "Html-Css", "javascript", "Three.js" , "javascript", "Three.js" ,"SQL", "Html-Css", "javascript", "Nextjs"]

var etude = [true, true, /*true, true, true, true,*/ false, false, false, false, true, true, false, true, true, true, false, false, true, false, false, false, false, false]
