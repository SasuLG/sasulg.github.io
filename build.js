...
var images = ['odomo.png', 'biosphère.png', 'Installation de Poste.PNG', 'BD.PNG', 'site.png', /*'PESTEL.png',*/ 'GenMdp.PNG', 'Quizz.png', 'Memories.png', 'jpo.png', 'graphe4.png', "game.png", "series.png", "livingforest3.png", "birds.png", "chess.png", "anges.png", "blinkApp.png", "lsf.png", "Skeletum.png" , "myanylist.png"]

var tabTitre =  ['Odomo', 'Biosphère', 'Installation de poste', 'Création de base de données', "Conception d'un site web", /*'Analyse PESTEL',*/ 'Générateur de mot de passe', 'Quizz', 'Memories', 'Jeu Java', 'Exploraiton algo', "Jeu 2d rpg" , "Développement d'appli", "Living Forest", "Birds", "Chess 3D AI", "Anges Mdm", "Blink App", "LSF Recognition", "Skeletum" , "MyAnyList"]
...
var date = ['2022', '2022', '2022', '2022', '2022', /*'2022',*/ '2023', '2023', '2023', '2023', '2023', "2023", "2024", "2025", "2025", "2025", "2025", "2025", "2025~2026", "2026" , "2024~2026"]
var nbLanguage = [1, 1, 1, 1, 1, /*1,*/ 2, 2, 2,1,1, 2, 4, 3, 2, 3, 3, 2, 2, 3, 4]
var nbLanguageTotal = nbLanguage.map(x => x).reduce((a, b) => a + b, 0) - 1
var Language = ['Java', 'Java', 'Shell', 'SQL', 'Html-Css', /*'Managment',*/ 'javascript', 'Html-Css', 'javascript', 'Html-Css', 'javascript', 'Html-Css', 'Java', "Java", "Html-Css", "javascript", "PHP", "Html-Css","javascript", "Managment", "javascript", "Html-Css", "React",  "Python", "Godot", "CSharp", "Unity", "Blender", "Html-Css", "javascript", "Nextjs", "Python", "OpenCV","Python", "OpenCV", "Html-Css", "javascript", "Three.js" , "SQL", "Html-Css", "javascript", "Nextjs"]

var etude = [true, true, true, true, true, /*true,*/ false, false, false, true, true, false, true, true, true, false, false, true, false, false, false]
